...
const jsonLd = wrapGraph([
  {
    ...
    contactPoint: {
      ...
      url: "https://t.me/PoizonAdvisor",
    },
    areaServed: ["RU", "KZ", "BY", "TJ", "UZ", "AM", "GE", "AZ"],
    sameAs: ["https://t.me/poizonsnggg"],
  },
  {
    "@type": "WebSite",
    "@id": `${SITE_URL}/#website`,
  ...
  },
  {
    "@type": "Service",
    "@id": `${SITE_URL}/#service`,
    name: "Байер Poizon для СНГ",
    provider: { "@id": `${SITE_URL}/#organization` },
    serviceType: "Байер / посредник по закупкам",
    description:
      "Выкупаем оригинальные кроссовки, одежду и аксессуары с китайской платформы Poizon (得物) и доставляем в Россию, Казахстан, Беларусь и другие страны СНГ. Авиадоставка от 3 дней.",
    areaServed: ["RU", "KZ", "BY", "TJ", "UZ", "AM", "GE", "AZ"],
    url: SITE_URL,
    offers: {
      "@type": "Offer",
      description: "Авиа (3–5 дней) — 225 ¥/кг, Экспресс (10–12 дней) — 173 ¥/кг, Стандарт (~25 дней) — 77 ¥/кг",
  ...
  faqPage([
    ...
    {
      q: "В чём отличие Poizon от AliExpress или Taobao?",
      a: "Poizon (得物) — платформа аутентификации, не обычный маркетплейс. Каждый товар проходит экспертную проверку подлинности перед отправкой покупателю. AliExpress и Taobao не гарантируют оригинальность.",
    },
    {
      q: "Можно ли купить кроссовки Nike или Adidas оригинал в России через Poizon?",
      a: "Да. POIZON SNG выкупает оригинальные Nike, Adidas, Jordan, New Balance и другие бренды на платформе Poizon в Китае и доставляет в Россию, Казахстан, Беларусь и другие страны СНГ авиапочтой от 3 дней.",
    },
  ]),
])
